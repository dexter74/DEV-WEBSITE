...
Choisir la police (Exemple: Roboto)
Puis dans la section Style, cliquer sur le Plus "Thin XXX" pour récuper le CSS dans la zone à droite. (Si sa appararaît pas, F5)
Coller le texte.
```
