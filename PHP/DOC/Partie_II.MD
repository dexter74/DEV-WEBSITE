...
### <p align='center'> Sommaire </p>
 ...
 - [Organisez vos données à l'aide des tableaux](https://openclassrooms.com/fr/courses/918836-concevez-votre-site-web-avec-php-et-mysql/4238931-organisez-vos-donnees-a-laide-des-tableaux)
 - [Exploitez toute la puissance des fonctions PHP !](https://openclassrooms.com/fr/courses/918836-concevez-votre-site-web-avec-php-et-mysql/912352-exploitez-toute-la-puissance-des-fonctions-php)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
### <p align='center'> [Exploitez toute la puissance des fonctions PHP !](https://openclassrooms.com/fr/courses/918836-concevez-votre-site-web-avec-php-et-mysql/912352-exploitez-toute-la-puissance-des-fonctions-php)</p>

### A. Comprenez le principe d'une fonction
#### 1. 
```php
```
#### 2. 
