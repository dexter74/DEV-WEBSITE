...
echo $users[1][0]; // 20
echo $users[1][1]; // Dexter74
echo $users[1][6]; // dexter74@mail.com
echo $users[2][0]; // 21
echo $users[2][1]; // Drthrax74
echo $users[2][6]; // drthrax74@mail.com
?>
```
...
$VALEUR = array('Jean-Claude','Halidi','Luc', 'Marc');
?>
```
